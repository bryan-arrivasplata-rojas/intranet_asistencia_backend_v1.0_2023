        ...
        @else
            ...
            @foreach ($response as $resp)
                <tr>
                    ...
                    <td>
                        <a href="{{route('types.edit',$resp->idType)}}" class="btn btn-primary"><i class="bi bi-brush-fill"></i></a>
                        <button class='btn btn-danger' type='submit' form="delete_{{$resp->idType}}" onclick="return confirm('¿Estás seguro de eliminar el registro?')"><i class="bi bi-trash3-fill"></i></button>
